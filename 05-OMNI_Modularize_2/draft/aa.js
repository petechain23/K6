...
let extendedStatus = 'processing'
let order_Id = 'order_01HV6526JPFB5B3F8QNW616Q5H'
const arrStatus = ['confirmed', 'ready_for_delivery', 'shipped', 'delivery', 'paid']
// let arrStatus = arrayStatus.length;
if (arrStatus.includes(extendedStatus)) {
  console.log('Order Status is Invalid, No Update Performed');
  // checkOrderStatusIsValid = false; // Mark as invalid
  // return checkOrderStatusIsValid = false;
}
else {
