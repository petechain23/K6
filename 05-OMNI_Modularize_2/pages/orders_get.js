...
//Before fix
  ...
  //Returned: const res = http.get(`${BASE_URL}/admin/orders?expand=outlet&fields=id,display_id,metadata,created_at,extended_status,outlet_id,credit_checked,inventory_checked,promotion_checked&order_type=returned&offset=0&limit=20&order=-created_at`, { headers: { cookies: cookies, 'Content-Type': 'application/json' } });
  //Distributor: const res = http.get(`${BASE_URL}/admin/orders?expand=outlet&fields=id,display_id,metadata,created_at,extended_status,outlet_id,credit_checked,inventory_checked,promotion_checked&order_type=standard&offset=0&limit=20&order=-created_at`, { headers: { cookies: cookies, 'Content-Type': 'application/json' } });
