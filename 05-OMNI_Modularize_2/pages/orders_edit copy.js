...
import { BASE_URL, editUrl, orderId } from '../config.js';
...
export function orderEdit(cookies) {
  ...
  const response = http.post(`${BASE_URL}/${editUrl}/${order_Id}`, payloadEditOrder,  { headers: { cookies: cookies, 'Content-Type': 'application/json' } });
